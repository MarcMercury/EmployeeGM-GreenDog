-- Migration: 075_seed_referral_partners.sql
-- Description: Seed referral_partners table with clinic data from Public Folder Master - All Clinics PDF
-- Contains: 143 veterinary clinics from the LA area

-- Insert clinics that don't already exist (using a CTE to filter)
...
-- Summary: Added new clinics from the Public Folder Master - All Clinics sheet (skipping existing ones)
