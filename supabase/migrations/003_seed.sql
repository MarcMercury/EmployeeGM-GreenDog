...
-- =====================================================
-- SEED DATA: Marketing Events & Leads
-- =====================================================
...
-- Seed sample marketing leads
INSERT INTO marketing_leads (lead_name, first_name, last_name, email, phone, source, status) VALUES
('Sarah Johnson', 'Sarah', 'Johnson', 'sarah.j@email.com', '(555) 222-3333', 'Website', 'contacted'),
('Mike Davis', 'Mike', 'Davis', 'mike.d@email.com', '(555) 333-4444', 'Referral', 'new'),
('Emily Chen', 'Emily', 'Chen', 'emily.c@email.com', '(555) 444-5555', 'Social Media', 'converted'),
('Robert Taylor', 'Robert', 'Taylor', 'robert.t@email.com', '(555) 555-6666', 'Walk-in', 'new'),
('Lisa Wong', 'Lisa', 'Wong', 'lisa.w@email.com', '(555) 666-7777', 'Pet Wellness Weekend', 'contacted')
ON CONFLICT DO NOTHING;

-- =====================================================
-- SEED DATA: Sample Candidates (Recruiting)
-- =====================================================
...
-- =====================================================
-- SEED DATA: Sample Referral Partners
-- =====================================================
INSERT INTO referral_partners (name, contact_name, email, phone, status, relationship_status) VALUES
('West LA Animal Hospital', 'Dr. Sarah Mitchell', 'smitchell@westlavet.com', '(310) 555-0101', 'active', 'established'),
('Beverly Hills Pet Clinic', 'Dr. Michael Chen', 'mchen@bhpetclinic.com', '(310) 555-0202', 'active', 'developing'),
('Santa Monica Veterinary Center', 'Dr. Lisa Rodriguez', 'lrodriguez@smvc.com', '(310) 555-0303', 'active', 'new'),
('Valley Animal Care', 'Dr. James Wilson', 'jwilson@valleyanimalcare.com', '(818) 555-0404', 'active', 'established'),
('Pasadena Pet Hospital', 'Dr. Emily Brown', 'ebrown@pasadenapethospital.com', '(626) 555-0505', 'active', 'developing')
ON CONFLICT DO NOTHING;
