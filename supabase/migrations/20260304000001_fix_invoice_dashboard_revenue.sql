-- Migration: Fix invoice dashboard revenue to use COALESCE fallback
-- If total_earned is NULL, fall back to price_after_discount.
-- This captures revenue from lines where total_earned wasn't imported.
...
DECLARE
  ...
  v_case_owners jsonb;
BEGIN
  -- Stats summary (exclude Header rows; use fallback chain for revenue)
