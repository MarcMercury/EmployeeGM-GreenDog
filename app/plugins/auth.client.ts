...
// NOTE: Redirect from auth pages is handled by middleware/auth.ts, NOT here
export default defineNuxtPlugin({
  ...
  async setup() {
    ...
    // Watch for auth state changes - just update stores, don't redirect
    ...
    // Get current session and load profile - don't redirect
