          ...
          <template v-if="hasCrmAnalyticsAccess">
            <div class="pt-2">
              ...
              <div class="section-content" :class="{ 'section-open': sections.crmAnalytics }">
                <NuxtLink to="/marketing/analytics" class="nav-link group" active-class="nav-link-active">
                  <div class="nav-icon-wrap group-hover:bg-emerald-500/20">📈</div>
                  Practice Analytics &amp; CRM
                </NuxtLink>
              </div>
            </div>
          </template>
          ...
          <template v-if="hasAdminOpsAccess">
            <div class="pt-2">
              ...
              <div class="section-content" :class="{ 'section-open': sections.adminOps }">
                ...
                <NuxtLink to="/admin/bonus-calculators" class="nav-link group" active-class="nav-link-active">
                  <div class="nav-icon-wrap group-hover:bg-emerald-500/20">💰</div>
                  Bonus Calculators
                </NuxtLink>
